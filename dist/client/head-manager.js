...
var HeadManager = function () {
  ...
  HeadManager.prototype.doUpdateHead = function doUpdateHead(head) {
    var _this2 = this;
  ...
  HeadManager.prototype.updateTitle = function updateTitle(component) {
    var title = void 0;
    if (component) {
  ...
  HeadManager.prototype.updateElements = function updateElements(type, components) {
