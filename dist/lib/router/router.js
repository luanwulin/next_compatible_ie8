  ...
  (0, _createClass3.default)(Router, [{
    ...
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(route, pathname, query, as) {
        var routeInfo, _window, _window$__NEXT_DATA__, buildId, assetPrefix, _routeInfo2, Component, ctx, _Component, _ctx;
        ...
        return _regenerator2.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                routeInfo = null;
                _window = window, _window$__NEXT_DATA__ = _window.__NEXT_DATA__, buildId = _window$__NEXT_DATA__.buildId, assetPrefix = _window$__NEXT_DATA__.assetPrefix;
                _context4.prev = 2;
              ...
              case 12:
                ctx = { pathname: pathname, query: query, asPath: as, assetPrefix: assetPrefix, buildId: buildId };
                _context4.next = 15;
