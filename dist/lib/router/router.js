...
/*#__PURE__*/
function () {
  function Router(_pathname, _query, _as2, _temp) {
    var _this = this;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              url = typeof _url === 'object' ? (0, _url2.format)(_url) : _url;
              as = typeof _as === 'object' ? (0, _url2.format)(_as) : _as; // Add the ending slash to the paths. So, we can serve the
  ...
  _proto.urlIsNew = function urlIsNew(pathname, query) {
    return this.pathname !== pathname || !(0, _shallowEquals["default"])(query, this.query);
  };

  _proto.isShallowRoutingPossible = function isShallowRoutingPossible(route) {
