  ...
  Server.prototype.defineRoutes = function defineRoutes() {
    ...
    var routes = {
      ...
      '/_next/:buildId/webpack/chunks/:name': function () {
        ...
        return function _nextBuildIdWebpackChunksName(_x5, _x6, _x7) {
      ...
      '/_next/:buildId/webpack/:id': function () {
        ...
        return function _nextBuildIdWebpackId(_x8, _x9, _x10) {
      ...
      '/_next/:buildId/page/_error*': function () {
        ...
        return function _nextBuildIdPage_error(_x23, _x24, _x25) {
      ...
      '/_next/:buildId/page/:path*': function () {
        ...
        return function _nextBuildIdPagePath(_x26, _x27, _x28) {
      ...
      '/_next/:path*': function () {
        ...
        return function _nextPath(_x29, _x30, _x31) {
      ...
      '/static/:path*': function () {
        ...
        return function staticPath(_x32, _x33, _x34) {
