...
var Server = function () {
  ...
  Server.prototype.setAssetPrefix = function setAssetPrefix(prefix) {
  ...
  Server.prototype.defineRoutes = function defineRoutes() {
    var _this3 = this;
    ...
    var routes = {
      ...
      '/_next/webpack/chunks/:name': function () {
        ...
        return function _nextWebpackChunksName(_x5, _x6, _x7) {
      ...
      '/_next/webpack/:id': function () {
        ...
        return function _nextWebpackId(_x8, _x9, _x10) {
      ...
      '/_next/:hash/manifest.js': function () {
        ...
        return function _nextHashManifestJs(_x11, _x12, _x13) {
      ...
      '/_next/:hash/main.js': function () {
        ...
        return function _nextHashMainJs(_x14, _x15, _x16) {
      ...
      '/_next/:hash/commons.js': function () {
        ...
        return function _nextHashCommonsJs(_x17, _x18, _x19) {
      ...
      '/_next/:hash/app.js': function () {
        ...
        return function _nextHashAppJs(_x20, _x21, _x22) {
      ...
      '/_next/:buildId/page/:path*.js.map': function () {
        ...
        return function _nextBuildIdPagePathJsMap(_x23, _x24, _x25) {
      ...
      '/_next/:buildId/page/_error.js': function () {
        ...
        return function _nextBuildIdPage_errorJs(_x26, _x27, _x28) {
      ...
      '/_next/:buildId/page/:path*.js': function () {
        ...
        return function _nextBuildIdPagePathJs(_x29, _x30, _x31) {
      ...
      '/_next/static/:path*': function () {
        ...
        return function _nextStaticPath(_x32, _x33, _x34) {
      ...
      '/_next/:path*': function () {
        ...
        return function _nextPath(_x35, _x36, _x37) {
      ...
      '/static/:path*': function () {
        ...
        return function staticPath(_x38, _x39, _x40) {
  ...
  Server.prototype.isServeableUrl = function isServeableUrl(path) {
  ...
  Server.prototype.handleBuildHash = function handleBuildHash(filename, hash, res) {
    if (this.dev) {
      res.setHeader('Cache-Control', 'no-store, must-revalidate');
      return true;
    }
  ...
  Server.prototype.send404 = function send404(res) {
    res.statusCode = 404;
