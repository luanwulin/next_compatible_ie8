...
export default class Router {
  constructor (pathname, query, as, baseRoute, { pageLoader, Component, ErrorComponent, err } = {}) {
  ...
  async getRouteInfo (route, pathname, query, as) {
    ...
    try {
      ...
      const ctx = { pathname, query, asPath: as, assetPrefix, resourceMap, buildId }
      ...
      const ctx = { err, pathname, query, assetPrefix, resourceMap, buildId }
      routeInfo.props = await this.getInitialProps(Component, ctx)
